...
$(window).on("resize",function() {
    console.log("We triggered the resize event.")
...
// The below is sjma3's added code for adding basic scrolling functionality.
$(window).on("scroll",function() {
    console.log("We triggered the scroll event.")
...
window.onload=function(){
    ...
    $(window).trigger('resize');
    $(window).trigger('scroll'); // added for scroll functionality
